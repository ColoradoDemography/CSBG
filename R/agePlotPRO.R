...
# Creating County level data
   f.agesum_cty = f.ctyAge %>%
            ...
            mutate( totalpopulation = b01001002 + b01001026,
                    ...
                    age1524 = b01001006 +b01001007 + b01001008 + b01001009 +b01001010 + b01001030 +
                      b01001031 + b01001032 + b01001033 +b01001034,
                    age2544 = b01001011 + b01001012 + b01001013 +b01001014 + b01001035 + b01001036 +
                      b01001037 + b01001038,
...
# If there is more than o county, produce a summary record for the agency
    ...
    f.agesum_agy = f.ctyAge %>%
            ...
            summarize( totalpopulation = sum(b01001002, b01001026),
                    ...
                    age1524 = sum(b01001006, b01001007, b01001008, b01001009, b01001010, b01001030, 
                                  b01001031, b01001032, b01001033, b01001034),
                    age2544 = sum(b01001011, b01001012, b01001013, b01001014, b01001035, b01001036, 
                                  b01001037, b01001038),
