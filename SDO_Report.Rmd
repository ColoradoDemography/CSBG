...
for(i in 1:length(ctyfips)) {
  agep <- readPNG(fixPath(filemat[grCount]))
  grid.raster(agep)
...
if("ageemp" %in% unlist(outChk)) {
   grCount <- 10
   for(i in 1:length(ctyfips)) {
       ageemp1p <- readPNG(fixPath(filemat[grCount]))
       grid.raster(ageemp1p)
       grCount <- grCount + 1

       ageemp2p <-readPNG(fixPath(filemat[grCount]))
       grid.raster(ageemp2p)
       grCount <- grCount + 1
    }
}
...
if("pov" %in% unlist(outChk)) {
   grCount <- 22
   for(i in 1:length(ctyfips)) {
       povp <- readPNG(fixPath(filemat[grCount]) ) 
       grid.raster(povp)
       grCount <- grCount + 1
}
...
if("educatt" %in% unlist(outChk)) {
    grCount <- 28
   for(i in 1:length(ctyfips)) {
       educp <- readPNG(fixPath(filemat[grCount]) ) 
       grid.raster(educp)
       grCount <- grCount + 1
     }
}
...
if("povage" %in% unlist(outChk)) {
   grCount <- 33
   for(i in 1:length(ctyfips)) {
       povagep <- readPNG(fixPath(filemat[grCount]) ) 
       grid.raster(povagep)
       grCount <- grCount + 1
     }
}
...
if("povagetr" %in% unlist(outChk)) {
   grCount <- 40
   for(i in 1:length(ctyfips)) {
       povagetrp <- readPNG(fixPath(filemat[grCount]) ) 
       grid.raster(povagetrp)
       grCount <- grCount + 1
    }
}
...
if("povagedis" %in% unlist(outChk)) {
   grCount <- 46
   for(i in 1:length(ctyfips)) {
       povagedisp <- readPNG(fixPath(filemat[grCount]) ) 
       grid.raster(povagedisp)
       grCount <- grCount + 1
    }
}
...
if("hhpov" %in% unlist(outChk)) {
   grCount <- 52
   for(i in 1:length(ctyfips)) {
       hhpovp <- readPNG(fixPath(filemat[grCount]) ) 
       grid.raster(hhpovp)
       grCount <- grCount + 1
    }
}
...
if("tenure" %in% unlist(outChk)) {
   grCount <- 58
   for(i in 1:length(ctyfips)) {
       tenurep <- readPNG(fixPath(filemat[grCount]) ) 
       grid.raster(tenurep)
       grCount <- grCount + 1
    }
}
...
if("snap" %in% unlist(outChk)) {
   grCount <- 64
   for(i in 1:length(ctyfips)) {
       snapp <- readPNG(fixPath(filemat[grCount]) ) 
       grid.raster(snapp)
       grCount <- grCount + 1
    }
}
...
if("wic" %in% unlist(outChk)) {
   grCount <- 70
   for(i in 1:length(ctyfips)) {
       wicp <- readPNG(fixPath(filemat[grCount]) ) 
       grid.raster(wicp)
       grCount <- grCount + 1
    }
}
...
if("insurance" %in% unlist(outChk)) {
    grCount <- 70
   for(i in 1:length(ctyfips)) {
       insurancep <- readPNG(fixPath(filemat[grCount])) 
       grid.raster(insurancep)
       grCount <- grCount + 1
    }
}
